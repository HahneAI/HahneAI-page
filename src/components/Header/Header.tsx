...
export function Header() {
  ...
  return (
    <header className="fixed w-full top-0 z-50 bg-opacity-90 bg-neutral-950/20 backdrop-blur-sm">
        ...
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex items-center">
            <div className="flex items-center">
              ...
              <div className="h-4 w-px mx-4 bg-gradient-to-b from-primary-500 to-secondary-400 opacity-50" />
              <button
          ...
          <button
            onClick={handleSystemRequestClick}
            className="hidden md:block bg-gradient-to-r from-primary-600 to-secondary-500 text-white px-6 py-2 rounded-lg hover:from-primary-700 hover:to-secondary-600 transition-all text-sm"
          >
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <button
                onClick={handleSystemRequestClick}
                className="block w-full text-left px-3 py-2 text-base font-medium text-neutral-300 hover:text-white transition-colors"
              >
                System Request
              </button>
              <button
              ...
              <button
                onClick={handleSystemRequestClick}
                className="block w-full px-3 py-2 text-base font-medium bg-gradient-to-r from-primary-600 to-secondary-500 text-white rounded-lg hover:from-primary-700 hover:to-secondary-600 transition-all"
              >
                Make a System Request
              </button>
            </div>
