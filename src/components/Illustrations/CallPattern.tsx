...
export function CallPattern() {
  return (
    ...
    >
      ...
      <circle cx="400" cy="300" r="150" fill="none" stroke="#3b82f6" strokeWidth="2" opacity="0.3" />
      <circle cx="400" cy="300" r="130" fill="none" stroke="#14b8a6" strokeWidth="2" opacity="0.4" />
      <circle cx="400" cy="300" r="110" fill="none" stroke="#3b82f6" strokeWidth="1" opacity="0.5" />
      ...
      <g transform="translate(250, 150)">
        <rect x="0" y="30" width="8" height="20" fill="#14b8a6" opacity="0.6" rx="2" />
        <rect x="15" y="20" width="8" height="30" fill="#14b8a6" opacity="0.7" rx="2" />
        <rect x="30" y="10" width="8" height="40" fill="#14b8a6" opacity="0.8" rx="2" />
        <rect x="45" y="0" width="8" height="50" fill="#14b8a6" opacity="0.9" rx="2" />
      </g>

      {/* Connection nodes */}
      <circle cx="550" cy="200" r="30" fill="url(#call-pulse)" />
      <circle cx="550" cy="200" r="15" fill="#14b8a6" opacity="0.8" />

      <circle cx="250" cy="400" r="25" fill="url(#call-pulse)" />
      <circle cx="250" cy="400" r="12" fill="#3b82f6" opacity="0.8" />
